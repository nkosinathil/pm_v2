...
<div class="breadcrumb">
    ...
    <a href="view-acquisition-form.php">Acquisition Forms</a> /
    ...
    <div class="sidebar">
        <div class="action-card">
            ...
            <div class="action-buttons">
                ...
                <a href="view-acquisition-form.php<?= !empty($acquisition['case_id']) ? '?job_code=' . urlencode($acquisition['case_id']) : '' ?>" class="btn btn-outline btn-block">
        ...
        <div class="action-card">
            ...
            <div class="action-buttons">
                <a href="view-acquisition-form.php?job_code=<?= urlencode($acquisition['case_id']) ?>" class="btn btn-outline btn-block">
